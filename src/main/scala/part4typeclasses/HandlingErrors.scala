...
object HandlingErrors {
  ...
  import cats.instances.either.* // implicit MonadError
  ...
  // Try and Future
  import cats.instances.try_.* // implicit MonadError[Try], E = Throwable
  ...
  val applyErrorVal = ApplicativeError[ErrorsOr, List[String]]
